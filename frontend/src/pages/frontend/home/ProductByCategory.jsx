      ...
      try {
        ...
        for (const category of categoriesResult.category) {
          try {
            ...
            // Console log để kiểm tra dữ liệu đã được lấy về từ mỗi danh mục
            console.log(
              `Products for category ${category.id}:`,
        ...
        // Console log để kiểm tra dữ liệu tổng cộng
        console.log("All products by category:", productsByCategoryData);
