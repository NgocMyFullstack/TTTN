...
if (isset($_SERVER['HTTP_ORIGINS']) && $_SERVER['HTTP_ORIGINS'] != "") {
    foreach ($allowedOrigins as $allowedOrigins) {
        if (preg_match('#' . $allowedOrigins . '#', $_SERVER['HTTP_ORIGINS'])) {
            header('Access-Control-Allow-Origin:' . $_SERVER['HTTP_ORIGINS']);
